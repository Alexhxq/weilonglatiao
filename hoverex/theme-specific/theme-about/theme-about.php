...
if (!function_exists('hoverex_about_page_builder')) {
	function hoverex_about_page_builder() {
		...
		<div class="hoverex_about">
			...
			<?php do_action('hoverex_action_theme_about_before_header', $theme); ?>

			<div class="hoverex_about_header">

				<?php do_action('hoverex_action_theme_about_before_logo'); ?>
				...
				<?php do_action('hoverex_action_theme_about_before_title', $theme); ?>
				...
				<?php do_action('hoverex_action_theme_about_before_description', $theme); ?>
				...
				<?php do_action('hoverex_action_theme_about_after_description', $theme); ?>

			</div>

			<?php do_action('hoverex_action_theme_about_before_tabs', $theme); ?>

			<div id="hoverex_about_tabs" class="hoverex_tabs hoverex_about_tabs">
				<ul>
					<?php do_action('hoverex_action_theme_about_before_tabs_list', $theme); ?>
					...
					<?php do_action('hoverex_action_theme_about_after_tabs_list', $theme); ?>
				</ul>

				<?php do_action('hoverex_action_theme_about_before_tabs_sections', $theme); ?>

				<div id="hoverex_about_section_start" class="hoverex_tabs_section hoverex_about_section"><?php
					...
					if (!HOVEREX_THEME_FREE_WP && !hoverex_exists_trx_addons()) {
						?><div class="hoverex_about_block"><div class="hoverex_about_block_inner">
							...
							<div class="hoverex_about_block_description"><?php
								esc_html_e('It is highly recommended that you install the companion plugin "ThemeREX Addons" to have access to the layouts builder, awesome shortcodes, team and testimonials, services and slider, and many other features ...', 'hoverex');
							?></div>
				...
				<?php do_action('hoverex_action_theme_about_after_tabs_sections', $theme); ?>
				
			</div>

			<?php do_action('hoverex_action_theme_about_after_tabs', $theme); ?>
